...
const year = Number(prompt("Enter a year you were born in", ""));
...
const num1 = Number(prompt("Enter first number", "0"));
const num2 = Number(prompt("Enter second number", "0"));
...
const inputYear = Number(prompt("Enter random year", "0"));
...
const num3 = Number(prompt("Enter a number to check if it is odd or even", "0"));
